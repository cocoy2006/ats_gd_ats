...
//    	System.out.println("VERBOSE:tag="+tag+";message="+message);
...
//    	System.out.println("DEBUG:tag="+tag+";message="+message);
...
//    	System.out.println("INFO:tag="+tag+";message="+message);
...
//    	System.out.println("WARN:tag="+tag+";message="+message);
...
//    	System.out.println("ERROR:tag="+tag+";message="+message);
